...
try:  # pragma: no cover - важно только сообщение при ошибке
    from google.oauth2.service_account import Credentials
    from googleapiclient.discovery import build
    from googleapiclient.http import MediaIoBaseUpload
except ModuleNotFoundError as exc:  # noqa: SIM105 - нужен перехват всех импортов
    raise ModuleNotFoundError(
        "Не найден модуль googleapiclient. Установите пакет "
